...
Shader "Water"
{
	Properties
	{
		...
		_NormalMult("NormalMult", Range( 0 , 1)) = 0.1
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_TexCoord30 = v.texcoord.xy + ( appendResult31 * _Float0 );
			...
			v.normal = ( appendResult36 * _NormalMult );
		}
...
/*ASEBEGIN
Version=17800
1155.2;454.4;1784;1095;1529.825;253.8486;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-1037.125,1024.052;Inherit;False;Property;_Float0;Float 0;9;0;Create;True;0;0;False;0;0.1;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;30;-502.6137,780.4213;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-215.5249,608.0516;Inherit;False;Property;_NormalMult;NormalMult;8;0;Create;True;0;0;False;0;0.1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;174.4752,585.9513;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-64.41212,205.2215;Inherit;False;Property;_Gloss;Gloss;7;0;Create;True;0;0;False;0;0.1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-67.73724,119.5959;Inherit;False;Property;_Spec;Spec;6;0;Create;True;0;0;False;0;0.1;0.75;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0199974B29D9EA0BF805A7BC41AE40071C512596